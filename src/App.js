  ...
  const services = [
    {
      title: 'basic Website',
      price: '499',
      features: ['1 page', 'SEO Friendly', 'Call button', 'Free SSL', 'WhatsApp Button Integration', 'Hosting not included', 'Annual Hosting Rs 7299'],
    },
    {
      ...
      <div className='header'>
        <header>
          ...
          <div className='header-btns'>
            ...
            <button onClick={openWhatsAppChat} className="contact-button">Contact us</button>
          </div>
        </header>
      </div>
      </AnimatedSection>
